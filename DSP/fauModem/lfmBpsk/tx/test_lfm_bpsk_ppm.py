...
lfm_bpsk_common.estimate_sample_ppm() + lfm_bpsk_rx.decode_packet()'s
...
contributor on cross-board hardware captures, 2026-08-28).

Unlike test_lfm_bpsk_selftest.py's build_multi_frame_capture() (which
...
lfm_bpsk_tx.build_cyclic_tx_packet()'s convention exactly, since ppm
...
def build_cyclic_waveform(frame_ids):
    ...
    lfm_bpsk_tx.build_cyclic_tx_packet()'s layout exactly."""
