...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net aclk_0_1 [get_bd_ports aclk] [get_bd_pins cic_compiler_0/aclk] [get_bd_pins decimator_config_0/axis_aclk] [get_bd_pins tdm_reformat_0/axis_aclk]
