...
proc create_hier_cell_DDC_Mixer { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir I -from 31 -to 0 ADC_Fc_scaled
  ...
  # Create instance: cic_compiler_imag, and set properties
  set cic_compiler_imag [ create_bd_cell -type ip -vlnv xilinx.com:ip:cic_compiler cic_compiler_imag ]
  set_property -dict [ list \
   CONFIG.Clock_Frequency {40.0000000} \
   ...
   CONFIG.Response_Magnitude {Output_Quantization} \
   CONFIG.SamplePeriod {1} \
   CONFIG.Sample_Rate_Changes {Programmable} \
 ] $cic_compiler_imag

  # Create instance: cic_compiler_real, and set properties
  set cic_compiler_real [ create_bd_cell -type ip -vlnv xilinx.com:ip:cic_compiler cic_compiler_real ]
  set_property -dict [ list \
   CONFIG.Clock_Frequency {40.0000000} \
   CONFIG.Filter_Type {Decimation} \
   CONFIG.Fixed_Or_Initial_Rate {160} \
  ...
  connect_bd_intf_net -intf_net AXIS_Splitter_0_M00_AXIS [get_bd_intf_pins AXIS_Splitter_0/M00_AXIS] [get_bd_intf_pins cic_compiler_imag/S_AXIS_CONFIG]
  connect_bd_intf_net -intf_net AXIS_Splitter_0_M01_AXIS [get_bd_intf_pins AXIS_Splitter_0/M01_AXIS] [get_bd_intf_pins cic_compiler_real/S_AXIS_CONFIG]
  ...
  connect_bd_intf_net -intf_net iq_concat2_0_m_axis [get_bd_intf_pins M_AXIS_DATA] [get_bd_intf_pins iq_concat2_0/m_axis]
  ...
  connect_bd_intf_net -intf_net s_axis_1 [get_bd_intf_pins S_AXIS_DATA] [get_bd_intf_pins iq_mixer_rx_40M_0/s_axis]

  # Create port connections
  connect_bd_net -net aclk_0_1 [get_bd_pins aclk] [get_bd_pins AXIS_Splitter_0/axis_aclk] [get_bd_pins cic_compiler_imag/aclk] [get_bd_pins cic_compiler_real/aclk] [get_bd_pins dds_compiler_0/aclk] [get_bd_pins decimator_config2_0/axis_aclk] [get_bd_pins iq_concat2_0/axis_aclk] [get_bd_pins iq_mixer_rx_40M_0/axis_aclk]
  connect_bd_net -net aresetn_1 [get_bd_pins aresetn] [get_bd_pins iq_mixer_rx_40M_0/axis_aresetn]
  connect_bd_net -net decimate_ratio_1 [get_bd_pins decimate_ratio] [get_bd_pins decimator_config2_0/i_decimate_ratio]
  connect_bd_net -net s_axis_phase_tdata_0_1 [get_bd_pins ADC_Fc_scaled] [get_bd_pins dds_compiler_0/s_axis_phase_tdata]
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set ADC_Fc_scaled [ create_bd_port -dir I -from 31 -to 0 ADC_Fc_scaled ]
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net DDC_Mixer1_M_AXIS_DATA [get_bd_intf_pins DDC_Mixer/M_AXIS_DATA] [get_bd_intf_pins axis_data_fifo_0/S_AXIS]
  connect_bd_intf_net -intf_net S_AXIS_1 [get_bd_intf_ports S_AXIS] [get_bd_intf_pins DDC_Mixer/S_AXIS_DATA]

  # Create port connections
  connect_bd_net -net aclk_0_1 [get_bd_ports aclk] [get_bd_pins axis_data_fifo_0/m_axis_aclk]
  connect_bd_net -net i_decimate_ratio_0_1 [get_bd_ports decimate_ratio] [get_bd_pins DDC_Mixer/decimate_ratio]
  connect_bd_net -net s_axis_aclk_0_1 [get_bd_ports aclk_10M] [get_bd_pins DDC_Mixer/aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk]
  connect_bd_net -net s_axis_aresetn_0_1 [get_bd_ports aresetn_10M] [get_bd_pins DDC_Mixer/aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn]
  connect_bd_net -net s_axis_phase_tdata_0_1 [get_bd_ports ADC_Fc_scaled] [get_bd_pins DDC_Mixer/ADC_Fc_scaled]
