...
################################################################
# This is a generated script based on design: cic_tx
#
...
proc create_root_design { parentCell } {
  ...
  set S_AXIS_CONFIG [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 S_AXIS_CONFIG ]
  set_property -dict [ list \
   CONFIG.HAS_TKEEP {0} \
   CONFIG.HAS_TLAST {0} \
   CONFIG.HAS_TREADY {1} \
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {M_AXIS:S_AXIS:S_AXIS_CONFIG} \
 ] $aclk
  ...
  connect_bd_intf_net -intf_net S_AXIS_CONFIG_0_1 [get_bd_intf_ports S_AXIS_CONFIG] [get_bd_intf_pins cic_compiler_0/S_AXIS_CONFIG]
  connect_bd_intf_net -intf_net S_AXIS_DATA_0_1 [get_bd_intf_ports S_AXIS] [get_bd_intf_pins cic_compiler_0/S_AXIS_DATA]
  ...
  connect_bd_net -net aclk_0_1 [get_bd_ports aclk] [get_bd_pins cic_compiler_0/aclk]
