...
proc create_hier_cell_Loopback { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net AXIS_Splitter_2_M00_AXIS [get_bd_intf_pins m_axis1] [get_bd_intf_pins AXIS_Splitter_2/M00_AXIS]
  ...
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins M00_AXIS] [get_bd_intf_pins AXIS_Splitter_0/M00_AXIS]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins S00_AXIS] [get_bd_intf_pins AXIS_Splitter_0/S00_AXIS]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins m_axis] [get_bd_intf_pins mux_0/m_axis]
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins s_axis2] [get_bd_intf_pins mux_2/s_axis0]
  ...
  connect_bd_intf_net -intf_net s_axis0_1 [get_bd_intf_pins s_axis0] [get_bd_intf_pins mux_1/s_axis0]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: system_ila_ddc, and set properties
  set system_ila_ddc [ create_bd_cell -type ip -vlnv xilinx.com:ip:system_ila system_ila_ddc ]
  set_property -dict [ list \
...
connect_bd_intf_net -intf_net [get_bd_intf_nets ADC_Chain_0_M_AXIS] [get_bd_intf_pins ADC_Chain_0/M_AXIS] [get_bd_intf_pins system_ila_ddc/SLOT_1_AXIS]
  connect_bd_intf_net -intf_net DAC_Chain_0_M_AXIS [get_bd_intf_pins ADC_Chain_0/S_AXIS] [get_bd_intf_pins DAC_Chain_0/M_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets DAC_Chain_0_M_AXIS] [get_bd_intf_pins DAC_Chain_0/M_AXIS] [get_bd_intf_pins system_ila_ddc/SLOT_0_AXIS]
  connect_bd_intf_net -intf_net Loopback_m_axis [get_bd_intf_pins Loopback/m_axis] [get_bd_intf_pins dma_tlast_gen_0/s_axis]
  ...
  connect_bd_intf_net -intf_net S_AXIS_1 [get_bd_intf_pins DAC_Chain_0/S_AXIS] [get_bd_intf_pins Loopback/M00_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_dma_0_M_AXIS_MM2S] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins system_ila_dma/SLOT_0_AXIS]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_MM2S [get_bd_intf_pins PS_Zynq_0/S_AXI_DMA_HP0] [get_bd_intf_pins axi_dma_0/M_AXI_MM2S]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_S2MM [get_bd_intf_pins PS_Zynq_0/S_AXI_DMA_HP1] [get_bd_intf_pins axi_dma_0/M_AXI_S2MM]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets dma_tlast_gen_0_m_axis] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins system_ila_dma/SLOT_1_AXIS]

  # Create port connections
  connect_bd_net -net PS_Zynq_0_Interp_ratio [get_bd_pins DAC_Chain_0/Interp_ratio] [get_bd_pins PS_Zynq_0/Interp_ratio]
  connect_bd_net -net PS_Zynq_0_aclk_100M [get_bd_pins ADC_Chain_0/aclk] [get_bd_pins DAC_Chain_0/aclk] [get_bd_pins Loopback/axis_aclk] [get_bd_pins PS_Zynq_0/aclk_100M] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins dma_tlast_gen_0/axis_aclk] [get_bd_pins system_ila_ddc/clk] [get_bd_pins system_ila_dma/clk]
  connect_bd_net -net PS_Zynq_0_aresetn_100M [get_bd_pins Loopback/axis_aresetn] [get_bd_pins PS_Zynq_0/aresetn_100M] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins dma_tlast_gen_0/axis_aresetn] [get_bd_pins system_ila_ddc/resetn] [get_bd_pins system_ila_dma/resetn]
  ...
  connect_bd_net -net PS_Zynq_0_duc_ddc_loopback [get_bd_pins Loopback/duc_ddc_loopback] [get_bd_pins PS_Zynq_0/duc_ddc_loopback]
