...
# module references:
# decimator_config, tdm_reformat_tx
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net cic_compiler_M_AXIS_DATA [get_bd_intf_ports M_AXIS] [get_bd_intf_pins cic_compiler/M_AXIS_DATA]
  ...
  connect_bd_net -net aclk_1 [get_bd_ports aclk] [get_bd_pins cic_compiler/aclk] [get_bd_pins interpolator_config/axis_aclk] [get_bd_pins tdm_reformat_tx/axis_aclk]
