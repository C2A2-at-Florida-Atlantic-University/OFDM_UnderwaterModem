...
# module references:
# mux, mux, mux, dma_data_splitter, dma_tlast_gen
...
proc create_hier_cell_dma { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net Loopback_M_AXIS_DMA [get_bd_intf_pins S_AXIS_DMA_DATA] [get_bd_intf_pins dma_tlast_gen_0/s_axis]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net DAC_Chain_0_m_axis_cic_direct [get_bd_intf_pins ADC_Chain_0/s_axis_cic] [get_bd_intf_pins DAC_Chain_0/m_axis_cic_direct]
  ...
  connect_bd_intf_net -intf_net S_AXIS_1 [get_bd_intf_pins Loopback/M_AXIS_SYNCHRONIZER] [get_bd_intf_pins Ofdm_Sync_250k_0/S_AXIS]
  ...
  connect_bd_intf_net -intf_net s_axis_dds_0_1 [get_bd_intf_pins ADC_Chain_0/s_axis_dds_0] [get_bd_intf_pins DAC_Chain_0/M00_AXIS_dds]
  ...
  connect_bd_net -net ADC_control_1 [get_bd_pins PS_Zynq_0/ADCcontrol]
  ...
  connect_bd_net -net DAC_control_1 [get_bd_pins PS_Zynq_0/DACcontrol]
  connect_bd_net -net Interp_ratio_1 [get_bd_pins ADC_Chain_0/decimate_ratio] [get_bd_pins DAC_Chain_0/Interp_ratio] [get_bd_pins PS_Zynq_0/Interp_ratio]
  connect_bd_net -net PS_Zynq_0_DAC_Fc_scaled [get_bd_pins DAC_Chain_0/Fc_scaled] [get_bd_pins PS_Zynq_0/DAC_Fc_scaled]
  connect_bd_net -net PS_Zynq_0_aresetn_100M [get_bd_pins ADC_Chain_0/axis_aresetn_0] [get_bd_pins DAC_Chain_0/aresetn] [get_bd_pins Loopback/axis_aresetn] [get_bd_pins Ofdm_Sync_250k_0/aresetn] [get_bd_pins PS_Zynq_0/aresetn_100M] [get_bd_pins dma/axis_aresetn]
  ...
  connect_bd_net -net aclk_40M_1 [get_bd_pins PS_Zynq_0/aclk_40M]
  connect_bd_net -net aresetn_10M_1 [get_bd_pins DAC_Chain_0/aresetn_10M] [get_bd_pins PS_Zynq_0/aresetn_10M]
  connect_bd_net -net aresetn_40M_1 [get_bd_pins PS_Zynq_0/aresetn_40M]
