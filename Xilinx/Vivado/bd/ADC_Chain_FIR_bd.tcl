...
proc create_hier_cell_DDC_Mixer { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.Coefficient_File {c:/O/Xilinx/Vivado/modules/data/DDC_FIR_512_tap_250000_BW.coe} \
  ...
  connect_bd_intf_net -intf_net fir_compiler_imag_1_M_AXIS_DATA [get_bd_intf_pins fir_compiler_real/M_AXIS_DATA] [get_bd_intf_pins iq_concat2_0/s_axis_real]
  connect_bd_intf_net -intf_net fir_compiler_imag_M_AXIS_DATA [get_bd_intf_pins fir_compiler_imag/M_AXIS_DATA] [get_bd_intf_pins iq_concat2_0/s_axis_imag]
  connect_bd_intf_net -intf_net iq_concat2_0_m_axis [get_bd_intf_pins m_axis] [get_bd_intf_pins iq_concat2_0/m_axis]
  connect_bd_intf_net -intf_net iq_mixer_rx_40M_0_m_axis_imag [get_bd_intf_pins fir_compiler_imag/S_AXIS_DATA] [get_bd_intf_pins iq_mixer_rx_40M_0/m_axis_imag]
  connect_bd_intf_net -intf_net iq_mixer_rx_40M_0_m_axis_real [get_bd_intf_pins fir_compiler_real/S_AXIS_DATA] [get_bd_intf_pins iq_mixer_rx_40M_0/m_axis_real]

  # Create port connections
  connect_bd_net -net aclk_40M_1 [get_bd_pins aclk_40M] [get_bd_pins AXIS_Splitter_0/axis_aclk] [get_bd_pins dds_compiler_0/aclk] [get_bd_pins decimator_config2_0/axis_aclk] [get_bd_pins fir_compiler_imag/aclk] [get_bd_pins fir_compiler_real/aclk] [get_bd_pins iq_concat2_0/axis_aclk] [get_bd_pins iq_mixer_rx_40M_0/axis_aclk]
