...
# module references:
# guard_insert, peak_sample, tdm_reformat_tx, tone, tx_off, decimator_config, iq_mixer_tx, peak_sample_duc
...
proc create_hier_cell_DUC_Mixer { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 M00_AXIS_dds
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 m_axis_cic_direct
  ...
  connect_bd_intf_net -intf_net AXIS_Splitter_0_M01_AXIS [get_bd_intf_pins AXIS_Splitter_0/M01_AXIS] [get_bd_intf_pins iq_mixer_tx/s_axis_dds]
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins M00_AXIS_dds] [get_bd_intf_pins AXIS_Splitter_0/M00_AXIS]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins m_axis_cic_direct] [get_bd_intf_pins peak_sample_duc_0/m_axis]
  connect_bd_intf_net -intf_net S_AXIS_DATA_1 [get_bd_intf_pins S_AXIS_DATA] [get_bd_intf_pins cic_compiler_0/S_AXIS_DATA]
  ...
  connect_bd_intf_net -intf_net fir_compiler_0_M_AXIS_DATA [get_bd_intf_pins cic_compiler_0/M_AXIS_DATA] [get_bd_intf_pins peak_sample_duc_0/s_axis]
  connect_bd_intf_net -intf_net interpolator_config_m_axis [get_bd_intf_pins cic_compiler_0/S_AXIS_CONFIG] [get_bd_intf_pins interpolator_config/m_axis]

  # Create port connections
  connect_bd_net -net Fc_scaled_1 [get_bd_pins Fc_scaled] [get_bd_pins dds_compiler_0/s_axis_phase_tdata]
  connect_bd_net -net aclk_1 [get_bd_pins aclk] [get_bd_pins AXIS_Splitter_0/axis_aclk] [get_bd_pins cic_compiler_0/aclk] [get_bd_pins dds_compiler_0/aclk] [get_bd_pins interpolator_config/axis_aclk] [get_bd_pins iq_mixer_tx/axis_aclk] [get_bd_pins peak_sample_duc_0/aclk]
  ...
  connect_bd_net -net i_trigger_0_1 [get_bd_pins i_trigger] [get_bd_pins peak_sample_duc_0/i_trigger]
...
proc create_root_design { parentCell } {
  ...
  set M00_AXIS_dds [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 M00_AXIS_dds ]
  ...
  set m_axis_cic_direct [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 m_axis_cic_direct ]
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {S_AXIS:M_AXIS:M00_AXIS_dds:m_axis_cic_direct} \
 ] $aclk
  ...
  # Create instance: axis_data_fifo1, and set properties
  set axis_data_fifo1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo axis_data_fifo1 ]
  set_property -dict [ list \
   CONFIG.IS_ACLK_ASYNC {1} \
 ] $axis_data_fifo1
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net DUC_Mixer_M00_AXIS_0 [get_bd_intf_ports M00_AXIS_dds] [get_bd_intf_pins DUC_Mixer/M00_AXIS_dds]
  connect_bd_intf_net -intf_net DUC_Mixer_M_AXIS_DATA [get_bd_intf_pins DUC_Mixer/M_AXIS_DATA] [get_bd_intf_pins axis_data_fifo/S_AXIS]
  connect_bd_intf_net -intf_net DUC_Mixer_m_axis_0 [get_bd_intf_ports m_axis_cic_direct] [get_bd_intf_pins DUC_Mixer/m_axis_cic_direct]
  connect_bd_intf_net -intf_net S_AXIS_1 [get_bd_intf_ports S_AXIS] [get_bd_intf_pins tone_0/s_axis]
  connect_bd_intf_net -intf_net axis_data_fifo1_M_AXIS [get_bd_intf_ports M_AXIS] [get_bd_intf_pins axis_data_fifo1/M_AXIS]
  ...
  connect_bd_intf_net -intf_net guard_insert_0_m_axis [get_bd_intf_pins guard_insert_0/m_axis] [get_bd_intf_pins tdm_reformat_tx/s_axis]
  ...
  connect_bd_intf_net -intf_net tx_off_0_m_axis [get_bd_intf_pins axis_data_fifo1/S_AXIS] [get_bd_intf_pins tx_off_0/m_axis]

  # Create port connections
  connect_bd_net -net DUC_Mixer_o_peak_sample_0 [get_bd_ports iq_square_sum_duc] [get_bd_pins DUC_Mixer/iq_square_sum_duc]
  connect_bd_net -net aclk_1 [get_bd_ports aclk] [get_bd_pins DUC_Mixer/aclk] [get_bd_pins axis_data_fifo/s_axis_aclk] [get_bd_pins axis_data_fifo1/m_axis_aclk] [get_bd_pins guard_insert_0/aclk] [get_bd_pins tdm_reformat_tx/axis_aclk] [get_bd_pins tone_0/axis_aclk] [get_bd_pins xpm_cdc_gen_0/src_clk]
  connect_bd_net -net aclk_10M_1 [get_bd_ports aclk_10M] [get_bd_pins axis_data_fifo/m_axis_aclk] [get_bd_pins axis_data_fifo1/s_axis_aclk] [get_bd_pins peak_sample_dac/aclk] [get_bd_pins tx_off_0/aclk] [get_bd_pins xpm_cdc_gen_0/dest_clk]
  connect_bd_net -net aresetn_1 [get_bd_ports aresetn] [get_bd_pins DUC_Mixer/aresetn] [get_bd_pins axis_data_fifo/s_axis_aresetn] [get_bd_pins guard_insert_0/aresetn]
  connect_bd_net -net aresetn_10M_1 [get_bd_ports aresetn_10M] [get_bd_pins axis_data_fifo1/s_axis_aresetn]
