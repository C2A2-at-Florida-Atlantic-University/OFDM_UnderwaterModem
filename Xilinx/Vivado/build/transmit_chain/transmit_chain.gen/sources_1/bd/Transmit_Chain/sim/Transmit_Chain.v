...
(* CORE_GENERATION_INFO = "Transmit_Chain,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=Transmit_Chain,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=11,numReposBlks=11,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=6,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "Transmit_Chain.hwdef" *) 
module Transmit_Chain
   (M_AXIS_tdata,
    ...
    playback_en,
    symbols_0);
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 M_AXIS TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME M_AXIS, CLK_DOMAIN Transmit_Chain_aclk, FREQ_HZ 100000000, HAS_TKEEP 0, HAS_TLAST 1, HAS_TREADY 0, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.0, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) output [31:0]M_AXIS_tdata;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 M_AXIS TLAST" *) output M_AXIS_tlast;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 M_AXIS TVALID" *) output M_AXIS_tvalid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 S_AXIS TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME S_AXIS, CLK_DOMAIN Transmit_Chain_aclk, FREQ_HZ 100000000, HAS_TKEEP 0, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.0, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) input [31:0]S_AXIS_tdata;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 S_AXIS TLAST" *) input S_AXIS_tlast;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 S_AXIS TREADY" *) output S_AXIS_tready;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 S_AXIS TVALID" *) input S_AXIS_tvalid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 S_BRAM_AXI ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME S_BRAM_AXI, ADDR_WIDTH 12, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN Transmit_Chain_aclk, DATA_WIDTH 32, FREQ_HZ 100000000, HAS_BRESP 1, HAS_BURST 1, HAS_CACHE 1, HAS_LOCK 1, HAS_PROT 1, HAS_QOS 0, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 0, INSERT_VIP 0, MAX_BURST_LENGTH 1, NUM_READ_OUTSTANDING 2, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 2, NUM_WRITE_THREADS 1, PHASE 0.0, PROTOCOL AXI4, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) input [11:0]S_BRAM_AXI_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.ACLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.ACLK, ASSOCIATED_BUSIF S_AXIS:M_AXIS:S_BRAM_AXI, ASSOCIATED_RESET aresetn, CLK_DOMAIN Transmit_Chain_aclk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input aclk;
  ...
  assign S_BRAM_AXI_1_ARADDR = S_BRAM_AXI_araddr[11:0];
  ...
  assign S_BRAM_AXI_1_ARLOCK = S_BRAM_AXI_arlock;
  ...
  assign S_BRAM_AXI_1_AWADDR = S_BRAM_AXI_awaddr[11:0];
  ...
  assign S_BRAM_AXI_1_AWLOCK = S_BRAM_AXI_awlock;
  ...
  Transmit_Chain_axi_bram_ctrl_0_1 axi_bram_ctrl_0
  ...
  Transmit_Chain_axis_data_fifo_0_1 axis_data_fifo_0
  ...
  Transmit_Chain_axis_data_fifo_1_1 axis_data_fifo_1
  ...
  Transmit_Chain_conj_0_1 conj_0
  ...
  Transmit_Chain_fft_config_0_1 fft_config_0
       (.axis_aclk(s_axi_aclk_0_1),
        .axis_aresetn(s_axi_aresetn_0_1),
  ...
  Transmit_Chain_playback_ctrl_0_1 playback_ctrl_0
       (.BRAM_PORT_addr(playback_ctrl_0_BRAM_PORT_ADDR),
        ...
        .symbols(symbols_0_1));
  Transmit_Chain_playback_mem_1 playback_mem
  ...
  Transmit_Chain_real_time_sampler_0_0 real_time_sampler_0
       (.axis_aclk(s_axi_aclk_0_1),
        .axis_aresetn(s_axi_aresetn_0_1),
        .dl_en(dl_en_0_1),
        .fs_cycles(fs_cycles_0_1),
  ...
  Transmit_Chain_tlast_gen_0_1 tlast_gen_0
       (.axis_aclk(s_axi_aclk_0_1),
        .axis_aresetn(s_axi_aresetn_0_1),
        .dl_en(dl_en_0_1),
        .i_start(dl_en_0_1),
