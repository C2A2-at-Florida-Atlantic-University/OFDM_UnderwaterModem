...
# Run "vivado -mode batch -source build_multichan_v2_reload.tcl"

set FAU_OFDM_REPO_PATH $::env(FAU_OFDM_REPO_PATH)
create_project -force multichan_v2_reload multichan_v2_reload -part xc7z020clg400-3
...
make_wrapper -files [get_files $FAU_OFDM_REPO_PATH/Xilinx/Vivado/build/multichan_v2_reload/multichan_v2_reload.srcs/sources_1/bd/Radio_Top_v2/Radio_Top_v2.bd] -top
add_files -norecurse $FAU_OFDM_REPO_PATH/Xilinx/Vivado/build/multichan_v2_reload/multichan_v2_reload.gen/sources_1/bd/Radio_Top_v2/hdl/Radio_Top_v2_wrapper.v
update_compile_order -fileset sources_1
