...
HD_PWD='C:/Projects/FAU-Modem/OFDM/Xilinx/Vivado/build/radio_top_pynq/radio_top_pynq.runs/Transmit_Chain_inst_0_ifft_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Transmit_Chain_inst_0_ifft_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Transmit_Chain_inst_0_ifft_0.tcl
