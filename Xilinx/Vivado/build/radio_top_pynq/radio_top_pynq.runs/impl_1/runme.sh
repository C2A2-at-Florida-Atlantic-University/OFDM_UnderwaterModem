...
HD_PWD='C:/Projects/FAU-Modem/OFDM/Xilinx/Vivado/build/radio_top_pynq/radio_top_pynq.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Radio_Top_Pynq_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Radio_Top_Pynq_wrapper.tcl -notrace
