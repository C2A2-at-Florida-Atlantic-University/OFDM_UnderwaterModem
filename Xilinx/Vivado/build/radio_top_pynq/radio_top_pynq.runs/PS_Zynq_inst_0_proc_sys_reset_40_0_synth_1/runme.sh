...
HD_PWD='C:/Projects/FAU-Modem/OFDM/Xilinx/Vivado/build/radio_top_pynq/radio_top_pynq.runs/PS_Zynq_inst_0_proc_sys_reset_40_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PS_Zynq_inst_0_proc_sys_reset_40_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PS_Zynq_inst_0_proc_sys_reset_40_0.tcl
