...
HD_PWD='C:/Projects/FAU-Modem/OFDM/Xilinx/Vivado/build/radio_top_pynq/radio_top_pynq.runs/Radio_Top_Pynq_axi_dma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Radio_Top_Pynq_axi_dma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Radio_Top_Pynq_axi_dma_0_0.tcl
