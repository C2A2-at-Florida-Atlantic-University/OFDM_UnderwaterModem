...
# Run "vivado -mode batch -source build_multichannel_radio_top.tcl"

set FAU_OFDM_REPO_PATH $::env(FAU_OFDM_REPO_PATH)
create_project -force multichannel_radio_top multichannel_radio_top -part xc7z010clg400-1
...
make_wrapper -files [get_files $FAU_OFDM_REPO_PATH/Xilinx/Vivado/build/multichannel_radio_top/multichannel_radio_top.srcs/sources_1/bd/Radio_Top_v2/Radio_Top_v2.bd] -top
add_files -norecurse $FAU_OFDM_REPO_PATH/Xilinx/Vivado/build/multichannel_radio_top/multichannel_radio_top.gen/sources_1/bd/Radio_Top_v2/hdl/Radio_Top_v2_wrapper.v
update_compile_order -fileset sources_1
