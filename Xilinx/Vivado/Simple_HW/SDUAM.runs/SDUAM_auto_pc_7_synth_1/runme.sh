...
HD_PWD='/home/saad/Xilinx/UnderwaterModem/Updated_MyXilinx/3Vivado_HW/SDUAM.runs/SDUAM_auto_pc_7_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SDUAM_auto_pc_7.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SDUAM_auto_pc_7.tcl
