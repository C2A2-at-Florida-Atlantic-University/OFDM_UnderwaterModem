...
HD_PWD='/media/saad/NVMe2/UnderwaterModem/Updated_MyXilinx/3_Simple_HW/SDUAM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SDUAM_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SDUAM_wrapper.tcl
