...
HD_PWD='/media/saad/NVMe2/UnderwaterModem/Updated_MyXilinx/3_Simple_HW/SDUAM.tmp/gpio_reg_array_v1_0_project/gpio_reg_array_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gpio_reg_array.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gpio_reg_array.tcl
