...
#define NUM_DUC_DDC_COEF 1025
#define NUM_PAD_SAMPLES 686
...
#define TX_ON_OFFSET 8
#define TX_ON_MASK 0x10000000
#define TX_ON_MASK_OFFSET 28
...
#define ADC_STATUS_STREAM_ENABLE 0x1
#define ADC_STATUS_STREAM_ENABLE_OFFSET 0
#define ADC_STATUS_OVER_RUN 0x2
#define ADC_STATUS_OVER_RUN_OFFSET 1
#define ADC_STATUS_OTR 0x4
#define ADC_STATUS_OTR_OFFSET 2
...
#define DAC_PEAK_OFFSET 8
#define DAC_PEAK_MASK 0x0000FFFF

#define ADC_PEAK_OFFSET 8
