...
#define DEFAULT_FREQ_DIGITAL_GAIN_DBFS -16
#define DEFAULT_ADDITIONAL_TIME_DOMAIN_GAIN_DB 6.4374 //For 4096 OFDM 16 Mod
...
#define DEFAULT_ADDITIONAL_SYNCHRONIZATION_GAIN_DB 9.0
