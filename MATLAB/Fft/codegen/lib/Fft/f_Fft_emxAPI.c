...
emxArray_creal_T *emxCreateND_creal_T(int numDimensions, const int *size)
{
  ...
  int i;
  int numEl;
  f_emxInit_creal_T(&emx, numDimensions);
  numEl = 1;
...
{
  f_emxInit_creal_T(pEmxArray, numDimensions);
}

/*
 * File trailer for f_Fft_emxAPI.c
 *
 * [EOF]
 */
