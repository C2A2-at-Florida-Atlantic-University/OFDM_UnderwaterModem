 ...
 * Return Type  : void
 */
void f_emxEnsureCapacity_creal_T(emxArray_creal_T *emxArray, int oldNumel)
{
  int i;
  int newNumel;
  void *newData;
 ...
 * Return Type  : void
 */
void f_emxEnsureCapacity_real_T(emxArray_real_T *emxArray, int oldNumel)
{
  int i;
  int newNumel;
  void *newData;
 ...
 * Return Type  : void
 */
void f_emxFree_creal_T(emxArray_creal_T **pEmxArray)
{
 ...
 * Return Type  : void
 */
void f_emxFree_real_T(emxArray_real_T **pEmxArray)
{
 ...
 * Return Type  : void
 */
void f_emxInit_creal_T(emxArray_creal_T **pEmxArray, int numDimensions)
{
 ...
 * Return Type  : void
 */
void f_emxInit_real_T(emxArray_real_T **pEmxArray)
{
...
/*
 * File trailer for f_Fft_emxutil.c
 *
 * [EOF]
 */
