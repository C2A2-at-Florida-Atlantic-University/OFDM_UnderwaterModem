 ...
 * Return Type  : void
 */
void h_emxEnsureCapacity_creal_T(emxArray_creal_T *emxArray, int oldNumel)
{
  int i;
  int newNumel;
  void *newData;
 ...
 * Return Type  : void
 */
void h_emxEnsureCapacity_real_T(emxArray_real_T *emxArray, int oldNumel)
{
  int i;
  int newNumel;
  void *newData;
 ...
 * Return Type  : void
 */
void h_emxFree_creal_T(emxArray_creal_T **pEmxArray)
{
 ...
 * Return Type  : void
 */
void h_emxFree_real_T(emxArray_real_T **pEmxArray)
{
 ...
 * Return Type  : void
 */
void h_emxInit_creal_T(emxArray_creal_T **pEmxArray, int numDimensions)
{
 ...
 * Return Type  : void
 */
void h_emxInit_real_T(emxArray_real_T **pEmxArray)
{
...
/*
 * File trailer for h_Decimate_emxutil.c
 *
 * [EOF]
 */
